                    ...
                    <form class="row g-3 pt-3" method="post" enctype="multipart/form-data">
                        <div class="col-md-12">
                            ...
                            <select class="form-control" id="stage" name="stage" disabled>
                                ...
                                $comp = "SELECT * FROM stage where id=$stage_id";
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="date" class="form-control" id="next_date" name="next_date"
                                value="<?php echo (isset($mode) && isset($data['alloted_date']) && !empty($data['alloted_date'])) ? date('Y-m-d', strtotime($data['alloted_date'])) : date('Y-m-d'); ?>" <?php
